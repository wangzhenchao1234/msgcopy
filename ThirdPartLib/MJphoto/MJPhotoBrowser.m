...
- (void)createToolbar
{
    ...
    _toolbar.titles = self.titles;
    _toolbar.descrs = self.descrs;
    ...
    _navbar.autoresizingMask = UIViewAutoresizingFlexibleTopMargin;
...
-(void)photoViewDidZoom:(MJPhotoView *)photoView{
    
}
- (void)photoViewImageFinishLoad:(MJPhotoView *)photoView
{
    _toolbar.currentPhotoIndex = _currentPhotoIndex;
    [_toolbar setSaveButtonEnable:YES];
...
- (void)showPhotoViewAtIndex:(int)index
{
    ...
    [_toolbar setSaveButtonEnable:NO];
