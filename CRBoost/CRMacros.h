...
#define DesignScale 2
#define AppDefaultWidth AppWindow.width*DesignScale


#define MSGCustomScale(length1,length2,initial_length1) (length2)*(initial_length1)/(length1)/DesignScale
#define MSGAppHeightScale(design_width,design_height) MSGCustomScale(design_width,design_height,AppDefaultWidth)
#define App3xScale(desig_length) desig_length*ScreenScale/(2.0f*DesignScale)
