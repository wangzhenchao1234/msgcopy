...
@property (weak, nonatomic) IBOutlet UIImageView *sendFailureImage;
 ...
 */
@property (weak, nonatomic, readonly) TYAttributedLabel *textView;
...
@property(nonatomic,assign)BOOL isHideFailureImage;
