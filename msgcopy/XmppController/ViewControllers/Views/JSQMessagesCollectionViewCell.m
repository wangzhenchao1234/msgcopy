...
@property (weak, nonatomic) IBOutlet TYAttributedLabel *textView;
...
- (void)awakeFromNib
{
    ...
    self.textView.linesSpacing = 2;
    self.textView.characterSpacing = 1.5;
    self.textView.lineBreakMode = kCTLineBreakByCharWrapping;
...
- (void)setAvatarViewSize:(CGSize)avatarViewSize
{
    ...
    self.avatarContainerView.layer.cornerRadius = avatarViewSize.height/2.0f;
...
- (CGSize)avatarViewSize
{
    ...
    CGSize size =  CGSizeMake(self.avatarContainerViewWidthConstraint.constant,
