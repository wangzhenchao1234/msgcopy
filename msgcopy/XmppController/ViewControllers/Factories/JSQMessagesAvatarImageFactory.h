 ...
 *  @return An initialized `JSQMessagesAvatarImage` object if created successfully, `nil` otherwise.
 */
+ (JSQMessagesAvatarImage *)avatarImageWithImage:(NSString *)image diameter:(NSUInteger)diameter;
 ...
 */
+ (UIImage *)circularAvatarImage:(NSString *)image withDiameter:(NSUInteger)diameter;
 ...
 *  @return A new image object if successful, `nil` otherwise.
 */
+ (UIImage *)circularAvatarHighlightedImage:(NSString *)image withDiameter:(NSUInteger)diameter;
