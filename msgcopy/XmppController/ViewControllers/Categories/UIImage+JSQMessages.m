...
+ (UIImage *)jsq_defaultRecordImage
{
    return [UIImage jsq_bubbleImageFromBundleWithName:@"bt_chat_record"];
}
+ (UIImage *)jsq_defaultKeyboardImage
{
    return [UIImage jsq_bubbleImageFromBundleWithName:@"bt_chat_keyboard"];
}
+ (UIImage *)jsq_defaultAttachImage
{
    return [UIImage jsq_bubbleImageFromBundleWithName:@"add_pic"];
}
+ (UIImage *)jsq_defaultEmotionImage
{
    return [UIImage jsq_bubbleImageFromBundleWithName:@"bt_chat_emotion"];
}
...
{
    return [UIImage jsq_bubbleImageFromBundleWithName:@"bt_chat_audio"];
}
+ (UIImage *)jsq_hilightedAudioImage
{
    return [UIImage jsq_bubbleImageFromBundleWithName:@"bt_chat_audio_s"];
}
