...
@interface GridBusinessController ()<UICollectionViewDelegateFlowLayout>
@end

@implementation GridBusinessController
...
static NSString * const reuseIdentifier = @"GridBusinessCell";
...
- (void)viewDidLoad {
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:@"GridBusinessCell" bundle:nil] forCellWithReuseIdentifier:@"GridBusinessCell"];
